...
> 本文是 v0.1 立项时的设计稿，其中的范围、计划与部分判断已被 v0.2/v0.3 实际实现修正。
> **当前事实以 `docs/HANDOFF_TO_GROK.md`、`experiments/published/` 和代码为准。**
> Dashboard 不在 v0.3 范围（v0.4）。v0.3 的实验结论见 `experiments/published/deepbench-v0.3/summary.md`。
