"""Exact 24-cell runner for the frozen v0.3.21 waypoint candidate.

Installs the research policy in this process only. Completed cells are never
rerun. Does not rerun v0.3.20 Guard or composite controls.
"""
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--out", default=os.path.join("experiments", "runs", "v0321-waypoint"))
