"""Browser runtime for v0.3.20 fresh composite targets.

Data comes from the v0.3.20 generator. This module is separate from the
v0.3.15 runtime and does not import exploration or result code.
"""
